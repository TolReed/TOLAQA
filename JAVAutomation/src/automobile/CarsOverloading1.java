...
// 3. Difference is sequence of data type of arguments
	 ...
	 */
public class CarsOverloading1 {//overloading - the same methods but with different parameters
	...
	public static void increaseSeatHeight(int heightToIncrease, boolean rememberHeight) {//add one more parameters here to get overloading - boolean rememberHeight
		System.out.println("Increased seat height by " + heightToIncrease + " inches");
		if (rememberHeight) {
