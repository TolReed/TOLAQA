...
public class CarsOverloading2 {
	...
	public static void increaseSeatHeight(int heightToIncrease) {//same methods - this excepts int
		System.out.println("Increased seat height by " + heightToIncrease + " inches. I am the interger one.");
	}
	
	public static void increaseSeatHeight(String heightToIncrease) {//same methods - this excepts String
